"""Composition root for Shopify product variants staging transformation."""
...
def run_shopify_product_variants_staging_transformation(
    settings: Settings,
    staging_dataset_id: str | None = None,
) -> TransformationResult:
    """Run the Shopify product variants staging transformation using runtime settings."""
